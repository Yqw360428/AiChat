...
abstract class ArchFullDialog<B : ViewBinding>(context: Context) : FullScreenPopupView(context) {
    lateinit var binding: B
    init {
        fullPopupContainer.addView(View(context))
    }
    ...
    override fun onCreate() {
        ...
        fullPopupContainer.removeAllViews()
